...
(function() {
  ...
  var ua = {
    ...
    fn: function(a, b, c) {
      ...
      return new u(a, function() {
        return function(a) {
          for (var b = new ha(d.D, d.O, d), c = Array.prototype.slice.call(arguments, 0), h = 0; h < c.length; h++)
  ...
  var z = {
      Jd: "concat every filter forEach hasOwnProperty indexOf join lastIndexOf map pop push reduce reduceRight reverse shift slice some sort splice unshift toString".split(" ")
    },
    xa = function(a) {
  ...
  function cb(a, b, c, d) {
    ...
    d ? ib[d] ? (ib[d].onSuccess.push(f), ib[d].onFailure.push(h)) : (ib[d] = {
      onSuccess: [f],
      onFailure: [h]
    }, J(a, function() {
  ...
  var Dc = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/),
    Ec = {
  ...
  function pd(a) {
    if (void 0 === ld[a.id]) {
      var b;
      if ("UA" == a.prefix) b = fd("gtagua", {
        trackingId: a.id
      });
      else if ("AW" == a.prefix) b = fd("gtagaw", {
        conversionId: a
      });
      else if ("DC" == a.prefix) b = fd("gtagfl", {
        targetId: a.id
      });
      else return;
      if (!md) {
            ...
            if (r) {
              ...
              if (A.active) {
                ...
                c: {
                  ...
                  for (var wa, Na = L, pb = cd(Na.xc), Ke = [], Hb = [], qb = 0; qb < Na.fb.length; qb++)
                    if (Na.fb[qb]) {
                      var Le = Lb[qb];
                      var eb = pb.add();
                      try {
                  ...
                  pb.ic();
                  for (var pc = 0; pc < Hb.length; pc++) Hb[pc]();wa = 0 < Hb.length;
  ...
  var ge = /(^|\.)doubleclick\.net$/i,
    he = /^(www\.)?google(\.com?)?(\.[a-z]{2})?$/,
    ie = function(a, b, c) {
    ...
    ze = function() {
      ...
      if (b && b.length)
        for (var k =
          ...
          "1" == l[0] && 3 == l.length && l[1] && (h[b[k].ib] || (h[b[k].ib] = []), h[b[k].ib].push({
            timestamp: l[1],
            ia: l[2]
          }))
        }
  ...
  var rf = function(a) {
    var b = Te + "?id=" + encodeURIComponent(a) + "&l=dataLayer",
      c = X("https://", "http://", b);
    J(c, void 0, void 0)
  };
    ...
    function() {
      ...
      (function(a) {
        ...
        var b = a.vtp_conversionId,
          ...
          M = !1 !== A("conversion_linker"),
          C = A("conversion_cookie_prefix");
        f && M && ye(C, void 0, void 0);
        if (f && x) {
          var N = A("phone_conversion_number"),
      ...
      function c(a, b, c) {
        ...
        if (h) {
          ...
          if ("gtag.config" === bc) l && ye(m, void 0, void 0), P(e);
            ...
            var x = c(k, h.containerId, h.Sb),
              F = 3 === df(),
              Y = !0 === k("allow_custom_scripts"),
              A = {
                ca: h.ca,
                Pa: l,
                Ba: m,
  ...
  Z.a.gtagua = ["google"],
    function() {
      var a, b = {
        ...
        h = function(a, b, c, d) {
          if (void 0 !== c)
            if (f[b] && (c = jc(c)), "anonymize_ip" != b || c || (c = void 0), 1 === a) d[k(b)] = c;
            else if (gc(a)) d[a] = c;
          else
      ...
      (function(a) {
        ...
        a || (a = !0, We("http://isaacbao.github.io/scripts/analytics.js", function() {
